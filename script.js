...
document.addEventListener('DOMContentLoaded', () => {
    ...
    const text = 'Built for stem organizing, mixing sessions, and sample pack curation.';
    ...
    if (heroDesc) {
        ...
        if (prefersReducedMotion) {
            heroDesc.insertBefore(document.createTextNode(text), cursor);
        } else {
            let i = 0;
            function typeChar() {
                if (i < text.length) {
...
(function() {
    const imgs = [
        ...
        'assets/screenshots/trackView.png',
        'assets/screenshots/tuner.png'
    ];

    const alts = [
        'Pulse main interface',
        'Pulse track list with waveforms and analysis',
        'Pulse toolbar with analysis actions',
        'Pulse category manager',
        'Pulse settings and configuration',
        'Pulse track view with BPM, key, tuner, and categories',
        'Pulse chromatic tuner with chroma spectrum and key detection'
    ];
